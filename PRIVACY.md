...
**What it stores locally:** Your settings (provider choice, API key, model names, prompt presets, metadata toggles) are stored in Chrome's local extension storage on your device only. Your Gemini API key never leaves your device except when sent directly to Google's API to authenticate your own requests.
...
**Contact:** [your email or GitHub issues URL]
